...
# Define sample order
df <- df %>%
  mutate(Plot_label = factor(df$Plot_label, levels = c("EB_3868 (saliva)",
                                                       "EB_3849 (CapScan_(SI))",
                                                       "EB_3850 (CapScan_(SI))",
                                                       "EB_3851 (CapScan_(SI))")))
...
# Set column order
col_order <- c("EB_3868 (saliva)", "EB_3849 (CapScan_(SI))", "EB_3850 (CapScan_(SI))", "EB_3851 (CapScan_(SI))",
...
pHeat
```
**Figure 2:** Heat map showing relative abundance of microbes in each sample (N = 292 total identified). Each row corresponds to a unique microbe and each column corresponds to an individual sample. Note the relative abundance colorscale is in log units.
...
* *Actinomyces naeslundii*:
  * Facilitates the initial colonization of tooth surfaces via biofilm formation (Dige *et al*., 2009)
  * Found in saliva (~0.9% relative abundance) and all 3 CapScan samples (0.07% - 3% relative abundance)
<br><br>
...
Dige, I., Raarup, M.K., Nyengaard, J.R., Kilian, M., and Nyvad, B. (2009) *Actinomyces naeslundii* in initial dental biofilm formation. *Microbiology* **155:** 2116–2126.